...
const visualRounds = [
  { id: "v1", kind: "visual", image: "assets/visual/kazakhstan-flag.png", imageAlt: "Государственный флаг Республики Казахстан", imagePosition: "center", title: "Флаг Республики Казахстан", points: 200, time: 40, question: "По совокупности признаков на изображении определите правовой статус объекта.", hint: "Голубое полотнище, солнце, орёл и национальный орнамент образуют официальный символ государства.", options: ["Государственный флаг Республики Казахстан", "Государственный герб Республики Казахстан", "Флаг другого государства", "Эмблема Конституционного Суда"], answerIndex: 0 },
  { id: "v2", kind: "visual", image: "assets/visual/kazakh-ballot-box.jpg", imageAlt: "Избирательная урна на участке в Астане, Казахстан", imagePosition: "center 52%", title: "Избирательная урна в РК", points: 200, time: 40, question: "Какой механизм волеизъявления граждан подтверждает ситуация на фотографии?", hint: "Урна на избирательном участке связана с голосованием граждан при выборах и референдуме.", options: ["Выборы и референдум", "Назначение Вице-президента", "Работа Правительства", "Конституционный контроль"], answerIndex: 0 },
  { id: "v3", kind: "visual", image: "assets/visual/constitutional-court-emblem.png", imageAlt: "Эмблема Конституционного Суда Республики Казахстан", imagePosition: "center", title: "Конституционный Суд РК", points: 300, time: 35, question: "Какой орган и какая функция соответствуют эмблеме на изображении?", hint: "Ищите орган, который проверяет соответствие правовых норм Конституции.", options: ["Конституционный Суд РК — конституционный контроль", "Верховный Суд РК — рассмотрение обычных судебных споров", "Курултай — принятие государственного бюджета", "Прокуратура — назначение Вице-президента"], answerIndex: 0 },
  { id: "v4", kind: "visual", image: "assets/visual/kazakhstan-parliament.jpg", imageAlt: "Здание Парламента Республики Казахстан в Астане", imagePosition: "center 48%", title: "Здание Парламента РК", points: 300, time: 35, question: "Какой элемент новой модели законодательной власти связан с этим зданием?", hint: "Сопоставьте здание законодательного института с переходом к однопалатной модели.", options: ["Конституционный Суд", "Курултай", "Правительство", "Прокуратура"], answerIndex: 1 },
  { id: "v5", kind: "visual", image: "assets/visual/constitution-of-kazakhstan.jpg", imageAlt: "Печатное издание Конституции Республики Казахстан", imagePosition: "center 48%", title: "Конституция РК", points: 400, time: 30, question: "Какую юридическую роль в системе права Республики Казахстан имеет документ на фотографии?", hint: "Он имеет высшую юридическую силу и определяет основы государства и права человека.", options: ["Конституция Республики Казахстан как Основной закон", "Уголовный кодекс как единственный источник прав человека", "Государственный бюджет как акт высшей юридической силы", "Трудовой договор как основа устройства государства"], answerIndex: 0 },
  { id: "v6", kind: "visual", image: "assets/visual/kazakhstan-supreme-court.jpg", imageAlt: "Здание Верховного Суда Республики Казахстан", imagePosition: "center 52%", title: "Верховный Суд РК", points: 400, time: 30, question: "Как одновременно определить орган на фотографии и его место в системе власти?", hint: "Назовите конкретный высший судебный орган и ветвь, которая осуществляет правосудие.", options: ["Верховный Суд РК — судебная власть", "Курултай — представительная власть", "Правительство — исполнительная власть", "Избирательная комиссия — орган конституционного контроля"], answerIndex: 0 },
];
